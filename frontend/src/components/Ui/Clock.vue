<template>
  ...
  <div
    class="clock"
    v-bind:style="clockStyle"
  >
    <div class="clock-circle" />
    <div
      class="clock-hour"
      v-bind:style="{transform:hourRotate}"
    />
    <div
      class="clock-minute"
      v-bind:style="{transform:minuteRotate}"
    />
    <div
      class="clock-second"
      v-bind:style="{transform:secondRotate}"
    />
    <b
      v-for="h in timeList"
      v-bind:key="h"
    ...
    >
      <span>
        <i v-bind:style="{transform:transform}">{{ h }}</i>
      </span>
    </b>
  </div>
</template>
